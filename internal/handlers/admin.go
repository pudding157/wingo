...
func (r *AdminHandler) GetAdminSettingBots(c echo.Context) error {
...
func (r *AdminHandler) PostAdminSettingBot(c echo.Context) error {
	...
	a := &models.AdminSettingBotListBind{}
	c.Bind(&a)
...
func (r *AdminHandler) DeleteAdminSettingBot(c echo.Context) error {

	fmt.Println("DeleteAdminSettingBot")

	w, err := r.Repo.DeleteAdminSettingBot()
	if err != nil {
		_res := models.ErrorResponse{}
		_res.Error = "Validation Failed"
		_res.ErrorMessage = err.Error()
